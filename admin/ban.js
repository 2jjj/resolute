...
exports.run = (bot,message,args) => {
  ...
  if(args.lenght === 0) return message.reply("use **f!ban <@Pessoa> <Motivo>** para banir alguém.");
  let banMember = message.mentions.members.first() || message.guild.members.cache.get(args[0]);
  if(!banMember) return message.reply("use **f!ban <@Pessoa> <Motivo>** para banir alguém.");
