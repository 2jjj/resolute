...
client.on("message", async (message) => {
    ...
    if(message.content.startsWith(prefix)) {
        ...
        if (command) {
            crystol.log(`[LOGS] - Comando ${commandName} usado por ${message.author.tag}`, "comandos.log", "America/Sao_Paulo").then(console.log((`[LOGS] - Comando ${commandName} usado por ${message.author.tag}`)))
            if(command.cooldown) {
