      ...
      message.channel.awaitMessages(m => m.author.id == message.author.id, {
        ...
        if (player.state !== "CONNECTED") {
          ...
          let playembed = new Discord.MessageEmbed()
            .setAuthor(`Adicionado à fila`, message.author.displayAvatarURL({
              dynamic: true
            }), "https://www.resolutebot.xyz")
            .setURL(track.uri)
  ...
  async function play(client, message, args, type) {
    ...
    function playlist_() {
      ...
      let playlistembed = new Discord.MessageEmbed()
        ...
        .setAuthor(`Playlist adicionada à fila`, message.author.displayAvatarURL({
          dynamic: true
        }), "https://www.resolutebot.xyz")
        .setColor(ee.color)
