...
exports.run = async (client, message, args) => {
  ...
  .setThumbnail(avatar)
	.addFields(
    { name: 'ﾠ', value: '<:info:845781463843602454> | Shards: <@836345581424738354>, <@798574984582791208>' },
    ...
    { name: 'ﾠ', value: `<:N3UP_Servers:845357935155478548> | Estou na versão **0.0.5**`, inline: false },
