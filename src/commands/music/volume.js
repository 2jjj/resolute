...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if(parseInt(args[0]) > 150 ||(args[0]) < 0) return sendError('<:information:843590035848429579> | Você não pode definir o volume para mais de 150 ou menor que zero, boboca! <:bravinha:841126251741970452>',message.channel).catch(err => console.log(err));
    ...
    .setAuthor("<:information:843590035848429579> | Gerenciamento do volume", `${message.author.displayAvatarURL({format: "png"})}`)
    .setColor("BLUE")
