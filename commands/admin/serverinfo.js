...
exports.run = async (client, message, args) => {
    ...
    .addField(`:pencil:  Dono`, `<@${message.guild.ownerID}>`)
    .addField(`:pencil:  ID do dono`, message.guild.ownerID)
    .addField(':date: Server Criado em', message.guild.createdAt, true)
    .addField(`:closed_lock_with_key: Proteção de verificação`, message.guild.verificationLevel, true)
